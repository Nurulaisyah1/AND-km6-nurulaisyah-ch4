...
class DummyMenuDataSource : MenuDataSource {
    ...
    override fun getMenus(): List<Menu> {
        return listOf(
            Menu(
                name = "Nasi Goreng",
                imgUrl ="https://github.com/Nurulaisyah1/Food_Asset/blob/main/Menu/img_fried_rice.jpeg",
                price = 5.99,
            ...
            Menu(
                name = "Ayam Goreng",
                imgUrl = "https://github.com/Nurulaisyah1/Food_Asset/blob/main/Menu/img_fried_chiken.jpeg",
                price = 7.99,
            ...
            Menu(
                name = "Mie Goreng",
                imgUrl = "https://github.com/Nurulaisyah1/Food_Asset/blob/main/Menu/img_fried_noodles.jpeg",
                price = 6.99,
            ...
            Menu(
                name = "Sate Ayam",
                imgUrl = "https://github.com/Nurulaisyah1/Food_Asset/blob/main/Menu/img_chiken_satay.jpeg",
                price = 8.99,
            ...
            Menu(
                name = "Cappucino",
                imgUrl = "https://example.com/gado_gado_image.jpeg",
                price = 6.49,
                desc = " Cappuccino adalah minuman kopi yang terdiri dari espresso, susu, dan busa susu"
            ),
            Menu(
                name = "Rendang",
                imgUrl = "https://github.com/Nurulaisyah1/Food_Asset/blob/main/Menu/img_rendang.jpeg",
                price = 9.99,
            ...
            Menu(
                name = "pizza",
                imgUrl = "hhttps://github.com/Nurulaisyah1/Food_Asset/blob/main/Menu/img_pizza.jpg",
                price = 5.49,
            ...
            Menu(
                name = "ice tea",
                imgUrl = "https://github.com/Nurulaisyah1/Food_Asset/blob/main/Menu/img_ice_tea.jpeg",
                price = 4.99,
                desc = "Es teh adalah minuman yang terbuat dari teh yang didinginkan dan disajikan dengan es."
            ),
            Menu(
                name = "Salmon sushi",
                imgUrl = "https://github.com/Nurulaisyah1/Food_Asset/blob/main/Menu/img_salmon-sushi.jpg",
                price = 5.99,
            ...
            Menu(
                name = "https://github.com/Nurulaisyah1/Food_Asset/blob/main/Menu/img_dumplings.jpg",
                imgUrl = "https://example.com/pisang_goreng_image.jpeg",
                price = 3.49,
