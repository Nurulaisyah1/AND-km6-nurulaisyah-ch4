...
class HomeViewModel(
    ...
    private val catalogRepository: MenuRepository,
    ...
    fun getMenus(category: String? = null) =
        catalogRepository.getMenus(category).asLiveData(Dispatchers.IO)

    fun getCategoryList() = categoryRepository.getCategories().asLiveData(Dispatchers.IO)
